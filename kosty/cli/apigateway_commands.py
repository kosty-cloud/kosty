...
def apigateway_audit(ctx, days, organization, region, max_workers, regions, output):
    ...
    execute_service_command(ctx, APIGatewayAuditService, 'audit', output, organization, region, max_workers, regions, days=days)
...
def apigateway_cost_audit(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.apigateway_audit import APIGatewayAuditService
    execute_service_command(ctx, APIGatewayAuditService, 'cost_audit', output, organization, region, max_workers, regions, days=days)
...
def apigateway_security_audit(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.apigateway_audit import APIGatewayAuditService
    execute_service_command(ctx, APIGatewayAuditService, 'security_audit', output, organization, region, max_workers, regions)
...
def apigateway_check_unused(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.apigateway_audit import APIGatewayAuditService
    execute_service_command(ctx, APIGatewayAuditService, 'check_unused_apis', output, organization, region, max_workers, regions, days=days)