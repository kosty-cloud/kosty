...
def ebs_audit(ctx, days, organization, region, max_workers, regions, output):
    ...
    execute_service_command(ctx, EBSAuditService, 'audit', output, organization, region, max_workers, regions, days=days)
...
def ebs_cost_audit(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.ebs_audit import EBSAuditService
    execute_service_command(ctx, EBSAuditService, 'cost_audit', output, organization, region, max_workers, regions, days=days)
...
def ebs_security_audit(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ebs_audit import EBSAuditService
    execute_service_command(ctx, EBSAuditService, 'security_audit', output, organization, region, max_workers, regions)
...
def ebs_check_orphan(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ebs_audit import EBSAuditService
    execute_service_command(ctx, EBSAuditService, 'check_orphan_volumes', output, organization, region, max_workers, regions)
...
def ebs_check_low_io(ctx, iops_threshold, days, organization, region, max_workers, regions, output):
    ...
    from ..services.ebs_audit import EBSAuditService
    execute_service_command(ctx, EBSAuditService, 'check_low_io_volumes', output, organization, region, max_workers, regions, iops_threshold=iops_threshold, days=days)
...
def ebs_check_old_snapshots(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.ebs_audit import EBSAuditService
    execute_service_command(ctx, EBSAuditService, 'check_old_snapshots', output, organization, region, max_workers, regions, days=days)
...
def ebs_check_gp2(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ebs_audit import EBSAuditService
    execute_service_command(ctx, EBSAuditService, 'check_gp2_volumes', output, organization, region, max_workers, regions)
...
def ebs_check_unencrypted_orphan(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ebs_audit import EBSAuditService
    execute_service_command(ctx, EBSAuditService, 'check_unencrypted_orphan', output, organization, region, max_workers, regions)
...
def ebs_check_unencrypted_in_use(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ebs_audit import EBSAuditService
    execute_service_command(ctx, EBSAuditService, 'check_unencrypted_in_use', output, organization, region, max_workers, regions)
...
def ebs_check_public_snapshots(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ebs_audit import EBSAuditService
    execute_service_command(ctx, EBSAuditService, 'check_public_snapshots', output, organization, region, max_workers, regions)
...
def ebs_check_no_recent_snapshot(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.ebs_audit import EBSAuditService
    execute_service_command(ctx, EBSAuditService, 'check_no_recent_snapshot', output, organization, region, max_workers, regions, days=days)