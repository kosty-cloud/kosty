...
def ec2_audit(ctx, days, cpu_threshold, organization, region, max_workers, regions, output):
    ...
    execute_service_command(ctx, EC2AuditService, 'audit', output, organization, region, max_workers, regions, days=days, cpu_threshold=cpu_threshold)
...
def ec2_cost_audit(ctx, days, cpu_threshold, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'cost_audit', output, organization, region, max_workers, regions, days=days, cpu_threshold=cpu_threshold)
...
def ec2_security_audit(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'security_audit', output, organization, region, max_workers, regions, days=days)
...
def ec2_check_oversized(ctx, cpu_threshold, days, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_oversized_instances', output, organization, region, max_workers, regions, cpu_threshold=cpu_threshold, days=days)
...
def ec2_check_stopped(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_stopped_instances', output, organization, region, max_workers, regions, days=days)
...
def ec2_check_idle(ctx, cpu_threshold, days, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_idle_instances', output, organization, region, max_workers, regions, cpu_threshold=cpu_threshold, days=days)
...
def ec2_check_previous_gen(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_previous_generation', output, organization, region, max_workers, regions)
...
def ec2_check_ssh(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_ssh_open', output, organization, region, max_workers, regions)
...
def ec2_check_rdp(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_rdp_open', output, organization, region, max_workers, regions)
...
def ec2_check_db_ports(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_database_ports_open', output, organization, region, max_workers, regions)
...
def ec2_check_public_non_web(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_public_non_web', output, organization, region, max_workers, regions)
...
def ec2_check_old_ami(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_old_ami', output, organization, region, max_workers, regions, days=days)
...
def ec2_check_imdsv1(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_imdsv1', output, organization, region, max_workers, regions)
...
def ec2_check_unencrypted_ebs(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_unencrypted_ebs', output, organization, region, max_workers, regions)
...
def ec2_check_no_backup(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'check_no_recent_backup', output, organization, region, max_workers, regions, days=days)