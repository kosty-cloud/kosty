...
def ec2_audit(ctx, days, cpu_threshold, organization, region, max_workers, regions, output, cross_account_role, org_admin_account_id):
    ...
    execute_service_command(ctx, EC2AuditService, 'audit', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id, cross_account_role, org_admin_account_id, days=days, cpu_threshold=cpu_threshold)
...
def ec2_cost_audit(ctx, days, cpu_threshold, organization, region, max_workers, regions, output, cross_account_role, org_admin_account_id):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'cost_audit', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id, cross_account_role, org_admin_account_id, days=days, cpu_threshold=cpu_threshold)
...
def ec2_security_audit(ctx, days, organization, region, max_workers, regions, output, cross_account_role, org_admin_account_id):
    ...
    from ..services.ec2_audit import EC2AuditService
    execute_service_command(ctx, EC2AuditService, 'security_audit', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id, cross_account_role, org_admin_account_id, days=days)
