...
def iam_audit(ctx, days, organization, region, max_workers, regions, output):
    ...
    execute_service_command(ctx, IAMAuditService, 'audit', output, organization, region, max_workers, regions, days=days)
...
def iam_security_audit(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'security_audit', output, organization, region, max_workers, regions, days=days)
...
def iam_check_root_keys(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'check_root_access_keys', output, organization, region, max_workers, regions)
...
def iam_cost_audit(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'cost_audit', output, organization, region, max_workers, regions, days=days)
...
def iam_check_unused_roles(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'check_unused_roles', output, organization, region, max_workers, regions, days=days)
...
def iam_check_inactive_users(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'check_inactive_users', output, organization, region, max_workers, regions, days=days)
...
def iam_check_old_keys(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'check_old_access_keys', output, organization, region, max_workers, regions, days=days)
...
def iam_check_wildcard_policies(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'check_wildcard_policies', output, organization, region, max_workers, regions)
...
def iam_check_admin_no_mfa(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'check_admin_no_mfa', output, organization, region, max_workers, regions)
...
def iam_check_weak_password(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'check_weak_password_policy', output, organization, region, max_workers, regions)
...
def iam_check_no_rotation(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'check_no_password_rotation', output, organization, region, max_workers, regions)
...
def iam_check_cross_account(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.iam_audit import IAMAuditService
    execute_service_command(ctx, IAMAuditService, 'check_cross_account_no_external_id', output, organization, region, max_workers, regions)