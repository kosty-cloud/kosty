...
def lambda_security_audit(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.lambda_audit import LambdaAuditService
    execute_service_command(ctx, LambdaAuditService, 'security_audit', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def lambda_check_memory(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.lambda_audit import LambdaAuditService
    execute_service_command(ctx, LambdaAuditService, 'check_over_provisioned_memory', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def lambda_check_timeout(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.lambda_audit import LambdaAuditService
    execute_service_command(ctx, LambdaAuditService, 'check_long_timeout_functions', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def lambda_check_public(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.lambda_audit import LambdaAuditService
    execute_service_command(ctx, LambdaAuditService, 'check_public_functions', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)