...
def s3_security_audit(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.s3_audit import S3AuditService
    execute_service_command(ctx, S3AuditService, 'security_audit', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def s3_check_empty(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.s3_audit import S3AuditService
    execute_service_command(ctx, S3AuditService, 'check_empty_buckets', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def s3_check_public_read(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.s3_audit import S3AuditService
    execute_service_command(ctx, S3AuditService, 'check_public_read_access', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def s3_check_public_write(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.s3_audit import S3AuditService
    execute_service_command(ctx, S3AuditService, 'check_public_write_access', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def s3_check_encryption(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.s3_audit import S3AuditService
    execute_service_command(ctx, S3AuditService, 'check_encryption_at_rest', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def s3_check_versioning(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.s3_audit import S3AuditService
    execute_service_command(ctx, S3AuditService, 'check_versioning_disabled', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def s3_check_logging(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.s3_audit import S3AuditService
    execute_service_command(ctx, S3AuditService, 'check_access_logging', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def s3_check_wildcards(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.s3_audit import S3AuditService
    execute_service_command(ctx, S3AuditService, 'check_bucket_policy_wildcards', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)
...
def s3_check_mfa_delete(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.s3_audit import S3AuditService
    execute_service_command(ctx, S3AuditService, 'check_mfa_delete', output, organization, region, max_workers, regions, cross_account_role, org_admin_account_id)