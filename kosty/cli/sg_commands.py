...
def sg_audit(ctx, organization, region, max_workers, regions, output):
    ...
    execute_service_command(ctx, SGAuditService, 'audit', output, organization, region, max_workers, regions)
...
def sg_cost_audit(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.sg_audit import SGAuditService
    execute_service_command(ctx, SGAuditService, 'cost_audit', output, organization, region, max_workers, regions)
...
def sg_security_audit(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.sg_audit import SGAuditService
    execute_service_command(ctx, SGAuditService, 'security_audit', output, organization, region, max_workers, regions)
...
def sg_check_unused(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.sg_audit import SGAuditService
    execute_service_command(ctx, SGAuditService, 'check_unused_groups', output, organization, region, max_workers, regions)
...
def sg_check_ssh_rdp(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.sg_audit import SGAuditService
    execute_service_command(ctx, SGAuditService, 'check_ssh_rdp_open', output, organization, region, max_workers, regions)
...
def sg_check_db_ports(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.sg_audit import SGAuditService
    execute_service_command(ctx, SGAuditService, 'check_database_ports_open', output, organization, region, max_workers, regions)
...
def sg_check_all_ports(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.sg_audit import SGAuditService
    execute_service_command(ctx, SGAuditService, 'check_all_ports_open', output, organization, region, max_workers, regions)
...
def sg_check_complex(ctx, rule_threshold, organization, region, max_workers, regions, output):
    ...
    from ..services.sg_audit import SGAuditService
    execute_service_command(ctx, SGAuditService, 'check_complex_security_groups', output, organization, region, max_workers, regions, rule_threshold=rule_threshold)