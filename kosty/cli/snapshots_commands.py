...
def snapshots_audit(ctx, days, organization, region, max_workers, regions, output):
    ...
    execute_service_command(ctx, SnapshotsAuditService, 'audit', output, organization, region, max_workers, regions, days=days)
...
def snapshots_cost_audit(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.snapshots_audit import SnapshotsAuditService
    execute_service_command(ctx, SnapshotsAuditService, 'cost_audit', output, organization, region, max_workers, regions, days=days)
...
def snapshots_security_audit(ctx, organization, region, max_workers, regions, output):
    ...
    from ..services.snapshots_audit import SnapshotsAuditService
    execute_service_command(ctx, SnapshotsAuditService, 'security_audit', output, organization, region, max_workers, regions)
...
def snapshots_check_old(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.snapshots_audit import SnapshotsAuditService
    execute_service_command(ctx, SnapshotsAuditService, 'check_old_snapshots', output, organization, region, max_workers, regions, days=days)
...
def snapshots_find_old(ctx, days, organization, region, max_workers, regions, output):
    ...
    from ..services.snapshots_audit import SnapshotsAuditService
    execute_service_command(ctx, SnapshotsAuditService, 'find_old_snapshots', output, organization, region, max_workers, regions, days=days)